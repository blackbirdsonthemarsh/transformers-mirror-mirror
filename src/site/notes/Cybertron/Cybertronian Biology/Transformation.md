---
{"dg-publish":true,"permalink":"/cybertron/cybertronian-biology/transformation/","dg-note-properties":{}}
---
...
The process by which [[Cybertronians\|Cybertronians]] change shape. Cybertronian bodies are built around the process of transformation, and Cybertronian [[Cybertron/Cybertronian Biology/Forging\|development]] is considered to be finished when they transform for the first time. 
...
Some Cybertronians, like [[Tracks\|Tracks]] and [[Characters/Decepticons/Decepticon Intelligence/Prowl\|Prowl]], can switch between a standard vehicle, and a version of that vehicle capable of flight or aquatic travel. 

Excessive transformation (which can sometimes manifest itself as the symptom of a mental disorder, a coping mechanism, or an addiction) puts strain on the body. 
##### Notes
---
