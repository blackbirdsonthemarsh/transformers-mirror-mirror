...
It was during one such case that he met the [[Characters/Decepticons/Prowl\|‘bot]] that would change the course of his life forever. A private investigator with a motormouth and a sense of justice that bordered on suicidal. Everywhere Chromedome went, there was that chatterbox, talking to the same witnesses, poking around the same places, and even taking note of the same clues!
